/*
 * Get description of a given file extension
 */

// CITE: file_extension_dict is from https://www.openoffice.org/dev_docs/source/file_extensions.html
const file_extension_dict =
    {
 ...
 */
const get_file_extension_description = function (ext) {
    return file_extension_dict[ext] ? file_extension_dict[ext]: 'File (Unknown Type)';
};